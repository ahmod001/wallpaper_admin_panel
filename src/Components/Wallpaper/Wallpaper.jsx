...
import { Button, Card, CardActionArea, CardActions, CardContent, Switch, Tooltip, Typography } from '@mui/material';
        ...
        <Card className='col sm:tw-w-full tw-w-9/12'
            ...
            <CardActionArea onClick={() => navigate(`/wallpapers/edit/${id}`)}>
                ...
                <div className='tw-relative tw-h-52 tw-overflow-hidden tw-pointer-events-none'>
                    {img ? <img className='tw-absolute tw-inset-0 tw-w-full tw-h-full tw-object-cover tw-object-center' src={img} />
